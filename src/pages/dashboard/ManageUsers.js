        ...
        <div className='flex flex-col'>
            ...
            <div className='flex gap-4'>
                <Link to='/settings/user-settings' className='flex gap-4 bg-white py-3 px-2 rounded-md cursor-pointer'>
                    <span className="material-symbols-outlined bg-gray w-[50px] h-[50px] rounded-[50%] flex items-center justify-center text-white">group</span>
                    <div className='flex flex-col mt-3'>
                        <div className='flex gap-2 items-center text-[#4BCA69]'>
                            <h3 className=''>Manage Users</h3><span className="material-symbols-outlined">trending_flat</span>
                        </div>
                ...
                <Link to='/settings/user-roles' className='flex gap-4 bg-white py-3 px-2 rounded-md cursor-pointer'>
                    ...
                    <div className='flex flex-col mt-3'>
                        <div className='flex gap-2 items-center text-[#4BCA69]'>
                            <h3 className=''>Manage Roles</h3><span className="material-symbols-outlined">trending_flat</span>
                        </div>
