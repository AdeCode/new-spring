...
function InputField({name, rows, label, type, value, placeholder, icon, component, ...props}) {
  ...
  return (
    <Div className='form-control flex flex-col mb-4 relative border-none lg:border'>
        ...
        <Field rows={rows} {...props} component={component} type={show ? 'text' : type} name={name} className='h-10 py-2 px-[14px] text-input_text text-sm font-[450] rounded-lg' placeholder={placeholder}/>
